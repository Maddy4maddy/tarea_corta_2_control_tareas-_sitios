...
if (!isset($_GET["id"])) {
    $_SESSION["error"] = "No se indicó la tarea que desea reactivar.";
...
if ($tarea["estado"] !== "Finalizada") {
    $_SESSION["error"] = "Solo se pueden reactivar tareas finalizadas.";
    header("Location: listar.php");
    exit;
}
...
$_SESSION["mensaje"] = "La tarea fue reactivada correctamente.";
header("Location: listar.php");
exit;